            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        verbose_name="Rango  de pobreza en donde se ubica su colonia",
                    ),
                ),
                (
                    "general_average",
                    models.CharField(
                        choices=[("0", "De 8.5 a 9.0"), ("1", "De 9.1 a 10")],
                        max_length=100,
                ...
                (
                    "dad_occupation",
                    models.CharField(
                        max_length=30, null=True, verbose_name="Ocupación del padre "
                    ),
                ),
                (
                    "dad_income",
                    models.FloatField(verbose_name="Ingresos mensuales del padre "),
                ),
                (
                    "mom_occupation",
                    models.CharField(
                        max_length=30, null=True, verbose_name="Ocupación de la madre "
                    ),
                ),
                (
                    "mom_income",
                    models.FloatField(verbose_name="Ingresos mensuales de la madre "),
                ),
                (
                    "son_occupation",
                    models.CharField(
                        max_length=30, null=True, verbose_name="Ocupación del hijo "
                    ),
                ),
                (
                    "son_income",
                    models.FloatField(verbose_name="Ingresos mensuales del hijo "),
                ),
                (
                ...
                (
                    "candidate_income",
                    models.FloatField(verbose_name="Ingresos mensuales del candidato "),
                ),
                (
                    "candidate_workplace",
                    models.CharField(
                        max_length=15,
                        null=True,
                        verbose_name="Lugar de trabajo del candidato",
                    ),
                ),
                (
                    "family_income",
                    models.CharField(
                        ...
                        max_length=50,
                        verbose_name="Ingreso total familiar mensual",
                    ),
                ),
                (
                    "exp_food",
                ...
                (
                    "exp_tv_internet",
                    models.FloatField(
                        verbose_name="Gastos mensuales aproximados dedicados a servicios de cable Tv e internet"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        verbose_name="Escolaridad del candidato",
                    ),
                ),
                (
                    "spous_scholar",
                    models.CharField(
                        ...
                        max_length=100,
                        verbose_name="Escolaridad del esposo/a",
                    ),
                ),
                (
                    "section3_obs",
