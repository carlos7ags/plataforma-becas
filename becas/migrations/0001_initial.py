# Generated by Django 3.1.4 on 2020-12-27 03:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_actual', models.CharField(max_length=30, verbose_name='Semestre/Cuatrimestre actual')),
                ('grado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='becas.grados', verbose_name='Grado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_ext', models.CharField(max_length=15, verbose_name='Número exterior')),
                ('numero_int', models.CharField(blank=True, max_length=15, null=True, verbose_name='Número interior')),
