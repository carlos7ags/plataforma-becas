...
ing_fa = (('0', 'De $0 a $3,696 pesos'), ('1', 'Más de $3,696 y hasta $7,393 pesos'),
          ('2', 'Más de $7,393 y hasta $11,089 pesos'), ('3', 'Más de $11,089 y hasta $14,786 pesos'),
          ('4', 'Más de $14,786 y hasta $18,483 pesos'), ('4', 'Más de $18,483 pesos'))

ep = (
('0', 'Ninguna'), ('1', 'Primaria'), ('2', 'Secundaria'), ('3', 'Preparatoria/Carrera técnica'), ('4', 'Licenciatura'),
...
pres = (('0', 'Ninguna prestación'),
        ('1', 'Servicio médico, sistema de ahorro para retiro, incapacidad laboral con goce de sueldo'))
...
te = (('0', 'Asbesto, palma, teja'), ('1', 'Lámina metálica arto'), ('2', 'Terrado con viguería'), ('3', 'Madera'),
...
op = ['1 - 0% (De 0 a 10 puntos)', '2 - 25% (De 11 a 20 puntos)', '3 - 50% (De 21 a 31 puntos)',
      '4 - 75% (De 31 a 41 puntos)', '5 - 100% (41 puntos o más)']
...
class SocioEconomicStudy(models.Model):
    ...
    poverty_range = models.CharField('Rango  de pobreza en donde se ubica su colonia', choices=rp, max_length=100)
    ...
    exp_food = models.FloatField('Gastos mensuales aproximados en comida ', blank=False, null=False)
    exp_rent = models.FloatField('Gastos mensuales aproximados en renta/hipoteca ', blank=False, null=False)
    exp_water = models.FloatField('Gastos mensuales aproximados en  el  servicio de agua', blank=False, null=False)
    exp_elect = models.FloatField('Gastos mensuales aproximados en el servicio de electricidad', blank=False,
                                  null=False)
    exp_diversion = models.FloatField('Gastos mensuales aproximados dedicados a la diversión ', blank=False, null=False)
    exp_transport = models.FloatField('Gastos mensuales aproximados dedicados al transporte', blank=False, null=False)
    exp_education = models.FloatField('Gastos mensuales aproximados dedicados a la educación', blank=False, null=False)
    exp_tv_internet = models.FloatField('Gastos mensuales aproximados dedicados a servicios de cable Tv e internet',
    ...
    healt_prov = models.CharField('El principal proveedor en el hogar está registrado o afiliado en:', choices=afi,
                                  max_length=100)
    ...
    water_service = models.CharField(
        ...
        choices=ag, max_length=100)
    drain_service = models.CharField(
        '¿ Su casa cuenta con servicio de drenaje conectado a una red pública o a una fora séptica ?:', choices=dre,
        max_length=100)
    elect_service = models.CharField(
        ...
        choices=ele, max_length=100)
    fuel_service = models.CharField(
        '¿ Su casa cuenta con servicio de drenaje conectado a una red pública o a una fora séptica ?:', choices=comb,
        max_length=100)
    ...
    veracity = models.BooleanField(' ¿ Confirma que toda la informacion proporcionada es verídica ?', null=True,
                                   blank=True)
    total_punct = models.IntegerField(
        'puntuación total obtenida en  el ESE ')  # este dato  debe ser calculado a partir de los resultados de cada apartado
