...
class SocioEconomicStudy(models.Model):
    ...
    exp_elect = models.FloatField('Gastos mensuales aproximados en el servicio de electricidad', blank=False, null=False)
    ...
    exp_tv_internet = models.FloatField('Gastos mensuales aproximados dedicados a servicios de cable Tv e internet', blank=False, null=False)
